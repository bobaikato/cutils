...
final class AccepterTest {
    ...
    void verifyAccepterThrowsException(Accepter<?> condition) {
        Assertions.assertThrows(Exception.class, () -> condition
    ...
    private static Stream<Arguments> accepterFunctions() {
        ...
        final Accepter<Class<?>> firstAccepter = value -> {
            throw new ClassCastException();
        };

        final Accepter<File> secondAccepter = value -> {
            throw new IllegalAccessException();
        };

        final Accepter<String> thirdAccepter = value -> {
            throw new NullPointerException();
        };

        return Stream.of(
                Arguments.of(firstAccepter),
                Arguments.of(secondAccepter),
                Arguments.of(thirdAccepter)
        );
    }
